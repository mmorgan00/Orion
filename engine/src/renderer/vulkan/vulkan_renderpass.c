...
void vulkan_renderpass_create(
    vulkan_context *context, vulkan_renderpass *out_renderpass,
    // TODO: Replace with proper struct when we implement math library
    f32 x, f32 y, f32 w, f32 h, f32 r, f32 g, f32 b, f32 a, f32 depth,
    u32 stencil) {
  ...
  color_attachment.initialLayout =
      VK_IMAGE_LAYOUT_UNDEFINED; // Do not expect any particular layout before
                                 // render pass starts.
...
void vulkan_renderpass_begin(vulkan_command_buffer *command_buffer,
  ...
  ozero_memory(clear_values, sizeof(VkClearValue) * 2);
