...
/*
 * @brief Invalid ID since we use u32's for ids. Any ID with this should be
 * considered not a real object u32 overflow. Update this if we change from u32
 * for id's
 */
...
// Linux OS
#define OPLATFORM_LINUX 1
#if defined(__ANDROID__)
#define OPLATFORM_ANDROID 1
#endif
#elif defined(__unix__)
// Catch anything not caught by the above.
#define OPLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
// Posix
#define OPLATFORM_POSIX 1
#elif __APPLE__
// Apple platforms
#define OPLATFORM_APPLE 1
#include <TargetConditionals.h>
#if TARGET_IPHONE_SIMULATOR
// iOS Simulator
#define OPLATFORM_IOS 1
#define OPLATFORM_IOS_SIMULATOR 1
